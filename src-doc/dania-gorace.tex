...
\recipe{Kurczak po seczuańsku}

\begin{Ingred}
    \item \qtyrange{300}{400}{\gram} marchwi
    \item \qty{200}{\gram} niesolonych orzeszków ziemnych
    \item około \qty{500}{\gram} cebuli
    \item \numrange{2}{3} jajka
    \item \numrange{2}{3} piersi kurczaka
    \item \num{.5} łyżeczki papryki ostrej
    \item \num{.5} łyżeczki pieprzu
    \item \num{1} szklanka wody
    \item \num{1} łyżka cukru
    \item \num{2} łyżeczki papryki słodkiej
    \item \num{2} łyżki mąki
    \item \num{2} łyżki octu ryżowego
    \item olej
    \item ryż
\end{Ingred}

Do miski wsypać drobno pokrojoną cebulę i~wymieszać z~sosem sojowym, \num{.25}
szklanki wody, octem, łyżką mąki ziemniaczanej, cukrem, paprykami słodką
i~ostrą oraz pieprzem. Całość odstawić do \enquote{przegryzienia} na
\qtyrange{2}{3}{\hour}. Marchewkę kroimy w~słupki lub kostkę, a~jak ktoś umie
to mogą być nawet serduszka. Rozdrabniamy orzeszki albo i~nie, wedle uznania,
ale lepiej przynajmniej parę razy potraktować młotkiem lub wałkiem. Zrobienie
ich na pył będzie przesadą, one dodają \enquote{treści} do dania. Piersi
kurczaka wypłukać, odsączyć i~pokroić w~drobną kostkę, a~następnie wymieszać
z~uprzednio roztrzepanymi jajkami i~łyżką mąki ziemniaczanej. Na głębokiej
patelni lub ewentualnie woku rozgrzać \num{.25} szklanki oleju i~smażyć piersi
kurczaka do całkowitego ścięcia. Ściągnąć z~patelni i~odstawić na później. Na
patelnię raz jeszcze wlewamy olej i~wrzucamy cebulkę z~marynatą i~marchewką.
Często mieszamy, ponieważ cukier i~sos mają tendencję do przywierania. Smażymy
kilka minut do miękkości i~następnie zalewamy wodą i~dusimy to kolejne
\qty{5}{\minute}. Wrzucamy kurczaka, trzymamy to na patelni kolejne
\qty{5}{\minute}. Dodajemy orzeszki, mieszamy i~zostawiamy jeszcze na
\qtyrange{2}{3}{\minute}.

Do ozdoby można użyć prażonego sezamu.
\end{document}
